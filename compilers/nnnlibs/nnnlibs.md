...
| JAX (Google)     | 2018  | ✔    | -    | 🅶   | 🏂 🔢 🔧 🧠  | 🟢𝔾 🟤 ⚪️c | intel, arm, R5           | NumPy, XLA            | OpenCL, Vulkan                       | Composable (function) transformations; high-performance differentiation, matrix ops, and autodiff via XLA |
<!-- JAX uses XLA? function composition? high-perf diff? JAX by Google? "transformations"? -->
